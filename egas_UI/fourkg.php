        ...
        <div class="container" style="margin-top: 22px">
            ...
            <div id="myCarousel">
                ...
                <div class="item active" style="height: 400px; width:1150px; ">
                    <img src="images/Banner---4Kg_0.png" alt="Los Angeles" style="width:100%;">
                    <div class="caption">
                        <h3 style="font-family: initial; color: #800000">4KG Cylinder :<span style="color: #800000; font-size: 20px; font-family: initial"> Super Easy and Super Safe</span></h3>
