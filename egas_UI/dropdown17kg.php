            ...
            <div class="col-lg-3" >
                ...
                <div class="form-group" >
                    ...
                    <div class="input-group" style="margin-top: 15px; margin-left: 25px;">
                        ...
                        <input type="text" name="text" id="inp" placeholder="Select to get Price" class="form-control" area-describedby="sizing-addon1" required>
                    </div>

                    <div style="margin-top: 25px;">
                        <ul style="font-size: 12px; font-family: sans-serif; color: #101010">
                            <li>4 KG Cylinder Price, Inclusive of All Taxes & Duties.
