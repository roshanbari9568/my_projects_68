            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active" style="height: 400px; width:1250px; ">
                        <img src="images/Auto-LPG_revised_0.png" alt="Los Angeles" style="width:100%;">
                        <div class="carousel-caption">
                            <h3>Visit Beautiful India</h3>
                            <p>A peaceful Country known for God of Nature!</p>
                        </div>
                    </div>
                    ...
                    <div class="item" style="height: 400px; width:1250px; ">
                        <img src="images/Home_0.png" alt="New York" style="width:100%;">
                        <div class="carousel-caption">
                            <h3>The Amaze Goa trip!</h3>
                            <p>Make your night rave true only here!</p>
                        </div>
                    </div>
                    ...
                    <div class="item" style="height: 400px; width:1250px; ">
                        ...
                        <div class="carousel-caption">
                            <h3>Take a taste of International Tours </h3>
                            <p>We always love to explore new places! !</p>
                        </div>
                    </div>
