    ...
    <body>
        ...
        <div class="container" style="margin-top: 22px">
            ...
            <div id="myCarousel">
                ...
                <div class="item active" style="height: 400px; width:1150px; ">
                    <img src="images/Leak-Detector_Banner_0.png" alt="Los Angeles" style="width:100%;">
                    <div class="caption">
                        <h3 style="font-family: initial; color: #800000">Be Safe from LPG leak Accidents: <span style="color: #800000; font-size: 20px; font-family: initial"> Safety Features</span></h3>
        ...
        <div class="container">
            <div>
                ...
                <a href="other.html" class="inlined" style="color: #000; margin-left: 5px; margin-right:5px; ">LPG Leak Detector For Home</a>
            ...
            <div class="container"   style="margin-top: 15px;">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="col-lg-4" style="margin-left: 50px;">
                        <div class="card">
                            <div style="margin-top: 45px;">
                                <img src="images/2KG/LeakDetector/Compact Size.png" alt="on-spot-connection" style="border: 1px solid #ddd;border-radius: 10px;padding: 55px;" />
                        ...
                        <div class="card">
                            <div style="margin-top: 45px;">
                                <img src="images/2KG/LeakDetector/Reliable Semiconductor Sensor.png" alt="Fully Refundable Deposit" style="border: 1px solid #ddd;border-radius: 10px;padding: 55px;" />
                    ...
                    <div class="col-lg-4" style="margin-left: 50px;">
                        ...
                        <div class="card">
                            <div style="margin-top: 45px;">
                                <img src="images/2KG/LeakDetector/Quick Response Time.png" alt="Quantity Quality Assuared" style="border: 1px solid #ddd;border-radius: 10px;padding: 55px;" />
                        ...
                        <div class="card">
                            <div style="margin-top: 45px;">
                                <img src="images/2KG/LeakDetector/In-built Stainless Steel Filter.png"  style="border: 1px solid #ddd;border-radius: 10px;padding: 55px;" />
